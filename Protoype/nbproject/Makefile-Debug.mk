...
LDLIBSOPTIONS=-L/usr/lib64 /usr/lib64/libsfml-graphics.so /usr/lib64/libsfml-system.so /usr/lib64/libsfml-window.so

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cppapplication_2

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cppapplication_2: /usr/lib64/libsfml-graphics.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cppapplication_2: /usr/lib64/libsfml-system.so

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/cppapplication_2: /usr/lib64/libsfml-window.so
...
${OBJECTDIR}/Objeto.o: Objeto.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Objeto.o Objeto.cpp

${OBJECTDIR}/Pj.o: Pj.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/include/SFML -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Pj.o Pj.cpp
