...
rMesh TRecursoMalla::processMesh(aiMesh *mesh, const aiScene *scene)
{
...
vector<Texture> TRecursoMalla::loadMaterialTextures(aiMaterial *mat, aiTextureType type, string typeName){
